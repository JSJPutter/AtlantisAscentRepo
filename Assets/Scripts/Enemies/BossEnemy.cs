...
public class BossEnemy : Enemy
{
    ...
    {
        currentPhase = (currentPhase + 1) % 2; // Cycle through phases
        phaseTimer = 0f;
        // You could add visual effects or sounds here to indicate phase change
    }
    ...
    {
        base.Stun();
        // Add visual effect for stunned boss
