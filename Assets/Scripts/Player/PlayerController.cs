...
public class PlayerController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        GameManager.Instance.UIManager.UpdateMaxHealthDisplay(maxHealth);
    }

    private void FixedUpdate()
    {
        float cameraHalfHeight = Camera.main.orthographicSize; // Half of the camera's height
        float cameraLowerBound = Camera.main.transform.position.y - cameraHalfHeight; // Subtract half height from camera Y position
        minY = cameraLowerBound+0.5f;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        else if(collision.gameObject.tag== "OxygenBubble")
        {
            GameManager.Instance.OxygenManager.AddOxygen(50);
    ...
    {
        GameManager.Instance.UIManager.UpdateHealthDisplay(currentHealth);
